...
public class Favorite extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        textView = view.findViewById(R.id.favorite_kosong);
    ...
    private void CheckUser (){
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("favorites").child(firebaseUser.getUid());
    ...
    private void BacaFavorite (){
        ...
        reference.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot){
                ...
                adapter = new Adapter_Favorite(getContext(),listwisata);
    ...
    public class Adapter_Favorite extends RecyclerView.Adapter<Adapter_Favorite.Holder> implements Filterable {

        Context context;
        List<Model_Pariwisata> listpantais;
        List<Model_Pariwisata> listwisata;

        public Adapter_Favorite(Context context, List<Model_Pariwisata> listpantais) {
