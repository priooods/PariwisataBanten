...
public class Adapter_Ulasan_Full extends RecyclerView.Adapter<Adapter_Ulasan_Full.Holder> {

    List<Model_Ulasan> ulasanList;
    Context mcontext;

    public Adapter_Ulasan_Full(List<Model_Ulasan> ulasanList, Context mcontext) {
